  ...
  return (
    <header className="sticky top-0 z-20 bg-gradient-to-r from-blue-800 to-blue-400 shadow-lg">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* Navigation Menu */}
        <nav
          className={`absolute top-full left-0 md:py-0 py-6 md:max-w-[30%] w-full bg-blue-800 lg:bg-transparent lg:static  transition-all duration-500 ease-in-out ${
        ...
        >
          <ul className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8 text-lg font-semibold">
            ...
            <li>
              <Link
                to="/login"
                className="py-2 px-6 text-white bg-yellow-400 hover:bg-yellow-500 rounded-full shadow-md transition-all duration-300 hover:scale-110 hover:shadow-xl"
              >
                Login
              </Link>
            </li>
